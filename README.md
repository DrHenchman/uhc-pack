# UHC Pack v0.8 for Minecraft 1.13+
...
1. Download the zip file for the [latest release](https://github.com/DrHenchman/uhc-pack/releases/download/v0.8/uhc-pack.zip) of the datapack
