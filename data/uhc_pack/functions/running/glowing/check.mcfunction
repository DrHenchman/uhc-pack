...
execute if score UHCGlow uhcEnabled matches 1 if score UHC uhcMin = UHC uhcGlow run tellraw @a [{"text":"UHC","color":"light_purple"},{"text":" \u2503 ","color":"reset"},{"text":"Glowing","color":"gray"},{"text":" \u2503 ","color":"reset"},{"text":"Activated", "color":"gold"}]
