...
execute if score UHC uhcState matches 4 if score Minute uhcTime >= GlowingStart uhcOption at @s run summon minecraft:area_effect_cloud ~ ~ ~ {Effects:[{Id:24,Duration:2000,ShowParticles:false}],Duration:20,Radius:1}
