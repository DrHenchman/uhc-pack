...
execute as @a[team=!spectate] if score @s uhcKills > UHC uhcPG store result score UHC uhcPG run scoreboard players get @s uhcKills
...
scoreboard players set UHC uhcPG 0
execute as @a[team=!spectate,advancements={uhc_pack:awards/mvp={triggered_most_kills=true}}] unless score @s uhcDeaths matches 1.. if score @s uhcHealth > UHC uhcPG store result score UHC uhcPG run scoreboard players get @s uhcHealth
...
scoreboard players set UHC uhcPG 0
execute as @a[team=!spectate,advancements={uhc_pack:awards/mvp={triggered_most_kills=true,triggered_most_health=true}}] if score @s uhcDDealt > UHC uhcPG store result score UHC uhcPG run scoreboard players get @s uhcDealt
