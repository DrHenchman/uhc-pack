...
execute as @a[team=!spectate] run scoreboard players operation HC uhcPG > @s uhcKills 
...
scoreboard players set UHC uhcPG 0
execute as @a[team=!spectate,advancements={uhc_pack:awards/mvp={triggered_most_kills=true}}] unless score @s uhcDeaths matches 1.. run scoreboard players operation HC uhcPG > @s uhcHealth
...
scoreboard players set UHC uhcPG 0
execute as @a[team=!spectate,advancements={uhc_pack:awards/mvp={triggered_most_kills=true,triggered_most_health=true}}] run scoreboard players operation HC uhcPG > @s uhcDealt
