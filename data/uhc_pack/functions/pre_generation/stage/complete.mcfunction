...
execute if score AlreadyLoadedOrigin uhcPG matches 0 positioned as @e[type=minecraft:armor_stand,tag=lobbycenter,limit=1] run function uhc_pack:pre_generation/stage/step/marker/origin/unload
