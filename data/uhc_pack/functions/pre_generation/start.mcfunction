...
execute if score UHC uhcBSize matches 496 at @e[type=minecraft:armor_stand,tag=lobby] run tp @s ~-248 253 ~-248
execute if score UHC uhcBSize matches 1008 at @e[type=minecraft:armor_stand,tag=lobby] run tp @s ~-248 253 ~-248
execute if score UHC uhcBSize matches 1520 at @e[type=minecraft:armor_stand,tag=lobby] run tp @s ~-248 253 ~-248
execute if score UHC uhcBSize matches 2032 at @e[type=minecraft:armor_stand,tag=lobby] run tp @s ~-248 253 ~-248
