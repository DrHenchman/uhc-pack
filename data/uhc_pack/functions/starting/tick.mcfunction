...
execute if score UHC uhcTick matches 80 as @a at @s run playsound minecraft:block.note.flute player @s ~ ~ ~ 1 0.5

execute if score UHC uhcTick matches 100 run title @a title {"text":"3","color":"gold"}
execute if score UHC uhcTick matches 100 as @a at @s run playsound minecraft:block.note.flute player @s ~ ~ ~ 1 0.5

execute if score UHC uhcTick matches 120 run title @a title {"text":"2","color":"gold"}
execute if score UHC uhcTick matches 120 as @a at @s run playsound minecraft:block.note.flute player @s ~ ~ ~ 1 0.5

execute if score UHC uhcTick matches 140 run title @a title {"text":"1","color":"gold"}
execute if score UHC uhcTick matches 140 as @a at @s run playsound minecraft:block.note.flute player @s ~ ~ ~ 1 0.5
