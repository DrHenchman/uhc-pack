...
execute if score @s[tag=admin] uhcOpt matches 17..18 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Teams ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcTeams"},"color":"gold"}]
...
execute if score @s[tag=admin] uhcOpt matches 19 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Randomized teams","color":"reset"}]
...
execute if score @s[tag=admin] uhcOpt matches 20..21 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"World size ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcBSize"},"color":"gold"}]
...
execute if score @s[tag=admin] uhcOpt matches 22..23 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Border shrink start ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcSBStrt"},"color":"gold"},{"text":" minutes","color":"reset"}]
...
execute if score @s[tag=admin] uhcOpt matches 24..25 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Border shrink size ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcSBSize"},"color":"gold"}]
...
execute if score @s[tag=admin] uhcOpt matches 26..27 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Border shrink duration ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcSBDur"},"color":"gold"},{"text":" minutes","color":"reset"}]
...
execute if score @s[tag=admin] uhcOpt matches 100..101 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Minute marker ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcMM"},"color":"gold"},{"text":" minutes","color":"reset"}]
...
execute if score @s[tag=admin] uhcOpt matches 102..103 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Eternal day start ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcEter"},"color":"gold"},{"text":" minutes","color":"reset"}]
...
execute if score @s[tag=admin] uhcOpt matches 104..105 run tellraw @a [{"text":"Options: ","color":"green"},{"text":"Glowing start ","color":"aqua"},{"text":"set to ","color":"reset"},{"score":{"name":"UHC","objective":"uhcMM"},"color":"gold"},{"text":" minutes","color":"reset"}]
